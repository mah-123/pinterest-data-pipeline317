...
invoke_url_pin = "https://4gzrfhhikb.execute-api.us-east-1.amazonaws.com/test/streams/streaming-0af64aa61d45-pin/record"
invoke_url_geo = "https://4gzrfhhikb.execute-api.us-east-1.amazonaws.com/test/streams/streaming-0af64aa61d45-geo/record"
invoke_url_user = "https://4gzrfhhikb.execute-api.us-east-1.amazonaws.com/test/streams/streaming-0af64aa61d45-user/record"
    ...
    while True:
        ...
        with engine.connect() as connection:
            ...
            payload_pin = json.dumps({
                    "StreamName": "streaming-0af64aa61d45-pin",
                    "Data": {
            ...
            payload_user = json.dumps({
                    ...
                    "Data": {
                            ...
                            "PartitionKey": "0af64aa61d45-user"
                            }, default=str)
